...
export const BuyCryptocurrenciesTab = (): JSX.Element => {
    const { handleCreateNewTransaction, coinSelected, valueInputQuantity, setValueInputQuantity,
    handleCloseModal, loading, messageSuccess} = useTransactions();
              ...
              <div>
                ...
                <label htmlFor='quantityOfCoins' className={styles.label}>
                  ...
                  <input
                    ...
                    {...register('referencePrice', { required: true, min: 1, max: valueInputQuantity })}
