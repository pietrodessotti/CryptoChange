...
export const SellCryptocurrenciesTab = (): JSX.Element => {
  ...
  const { handleCreateNewTransaction, valueInputQuantity, coinSelected,
    setValueInputQuantity, loading, typeCurrency, messageSuccess, handleCloseModal } = useTransactions();
          ...
          <div>
            ...
            <label htmlFor='quantityOfCoins' className={styles.label}>
              ...
              <input
                ...
                {...register('quantity', { required: true, min: 0.00001, max: valueInputQuantity })}
